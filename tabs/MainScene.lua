...
function MainScene:draw()
    ...
    text("Artwork", WIDTH/2-300, HEIGHT/2+100) --subtitle
...
function MainScene:touched(touch)
    ...
    buttonToArtwork:touched(touch)
    buttonToStore:touched(touch)
    
    if(buttonToMainGame.selected == true) then
        Scene.Change("game")
    elseif(buttonToArtwork.selected == true) then
